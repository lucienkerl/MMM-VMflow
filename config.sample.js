...
// ---------------------------------------------------------------------------
{
  ...
  config: {
    ...
    // maxRefillRows: 9,        // TOTAL budget split evenly across machines (keeps all visible); omit = show all
    // maxRowsPerMachine: 3,    // cap product rows PER machine (keeps every machine visible); omit = show all
  }
},
